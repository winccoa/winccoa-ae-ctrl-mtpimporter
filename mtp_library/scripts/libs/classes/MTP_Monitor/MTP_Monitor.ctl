...
/**
 * @class MTP_Monitor
 * @brief Represents the MTP_Monitor class.
 */
class MTP_Monitor
{
  ...
  /**
   * @brief Constructor for MTP_Monitor.
   *
   ...
   */
  public MTP_Monitor(const string &dpeEnabled, const string &dpeSafePosition, const string &dpeStaticError, const string &dpeDynamicError, const string &dpeStaticTime, const string &dpeDynamicTime)
  {
