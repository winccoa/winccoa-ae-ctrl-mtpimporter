...
/**
 * @class MTP_BinVlv
 * @brief Represents the MTP_BinVlv class.
 */
class MTP_BinVlv : MTP_ActiveElement
{
  ...
  /**
   * @brief Constructor for MTP_BinVlv.
   *
   * @param dp The data point path for the valve.
   */
  public MTP_BinVlv(const string &dp) : MTP_ActiveElement(dp)
  {
