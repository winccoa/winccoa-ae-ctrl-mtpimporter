...
/**
 * @class MTP_Security
 * @brief Represents the MTP_Security class.
 */
class MTP_Security
{
  ...
  /**
   * @brief Constructor for MTP_Security.
   *
   ...
   */
  public MTP_Security(const string &dpePermissionEnabled, const string &dpePermit, const string &dpeInterlockEnabled, const string &dpeInterlock, const string &dpeProtectionEnabled, const string &dpeProtection)
  {
