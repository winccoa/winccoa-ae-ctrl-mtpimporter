...
/**
 * @class MTP_DIntManIntFaceplateHome
 * @brief Represents the MTP_DIntManIntFaceplateHome class.
 */
class MTP_DIntManIntFaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_DIntManIntFaceplateHome.
   *
   * @param viewModel A shared pointer to the MTP_DIntManInt view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_DIntManIntFaceplateHome(shared_ptr<MTP_DIntManInt> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_refBarIndicator, MTP_BarIndicator::setValueCustomLimit, MTP_ViewBase::getViewModel(), MTP_DIntManInt::valueOutChanged);
    classConnect(this, setValueFeedbackCB, MTP_ViewBase::getViewModel(), MTP_DIntManInt::valueFeedbackChanged);
    classConnect(this, setValueInternalCB, MTP_ViewBase::getViewModel(), MTP_DIntManInt::valueInternalChanged);
    ...
    _refBarIndicator.makeIntegerBarIndicator();
   ...
   */
  private void setValueManualText(const int &valueManual)
  {
   ...
   */
  private void setValueFeedbackCB(const int &value)
  {
   ...
   */
  private void setValueInternalCB(const int &valueInternal)
  {
