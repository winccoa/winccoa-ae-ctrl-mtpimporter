...
/**
 * @class MTP_AnaVlvFaceplateHome
 * @brief Represents the MTP_AnaVlvFaceplateHome class.
 */
class MTP_AnaVlvFaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_AnaVlvFaceplateHome.
   *
   * @param viewModel A shared pointer to the MTP_AnaVlv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_AnaVlvFaceplateHome(shared_ptr<MTP_AnaVlv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_refBarIndicator, MTP_BarIndicator::setValueCustomLimit, MTP_ViewBase::getViewModel(), MTP_AnaVlv::positionFeedbackChanged);

    classConnectUserData(this, setValveCB, "_openFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openFeedbackChanged);
    classConnectUserData(this, setValveCB, "_closeFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeFeedbackChanged);
    classConnectUserData(this, setValveCB, "_openActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openActiveChanged);
    classConnectUserData(this, setValveCB, "_closeActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeActiveChanged);

    classConnect(this, setOsLevelCB, MTP_ViewBase::getViewModel().getOsLevel(), MTP_OsLevel::osStationLevelChanged);

    classConnectUserData(this, setSafetyPositionActiveCB, "_safetypositionActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::safetyPositionActiveChanged);
    classConnectUserData(this, setSafetyPositionActiveCB, "_safetypositionEnabled", MTP_ViewBase::getViewModel(), MTP_AnaVlv::safetyPositionEnabledChanged);
    ...
    classConnectUserData(this, setAutomaticPreviewLineCB, "_openAutomatic", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openAutomaticChanged);
    classConnectUserData(this, setAutomaticPreviewLineCB, "_closeAutomatic", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeAutomaticChanged);
    ...
    classConnectUserData(this, setValveCloseCB, "_openFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openFeedbackChanged);
    classConnectUserData(this, setValveCloseCB, "_closeFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeFeedbackChanged);
    classConnectUserData(this, setValveCloseCB, "_openActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openActiveChanged);
    classConnectUserData(this, setValveCloseCB, "_closeActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeActiveChanged);
    ...
    classConnectUserData(this, setValveOpenCB, "_openFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openFeedbackChanged);
    classConnectUserData(this, setValveOpenCB, "_closeFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeFeedbackChanged);
    classConnectUserData(this, setValveOpenCB, "_openActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::openActiveChanged);
    classConnectUserData(this, setValveOpenCB, "_closeActive", MTP_ViewBase::getViewModel(), MTP_AnaVlv::closeActiveChanged);
  ...
  {
    MTP_ViewBase::openChildPanel("objects_parts/faceplates/MTP_AnaVlv/main_SafetyPositionInformation.pnl", "SafetyPosition Information");
  }
