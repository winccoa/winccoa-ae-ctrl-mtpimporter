...
/**
 * @class MTP_AnaVlvFaceplateHome2
 * @brief Represents the MTP_AnaVlvFaceplateHome2 class.
 */
class MTP_AnaVlvFaceplateHome2 : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_AnaVlvFaceplateHome2.
   *
   * @param viewModel A shared pointer to the MTP_AnaVlv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_AnaVlvFaceplateHome2(shared_ptr<MTP_AnaVlv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_refBarIndicator, MTP_BarIndicator::setValueCustomLimit, MTP_ViewBase::getViewModel(), MTP_AnaVlv::positionChanged);
    classConnect(this, setPosFeedbackValueCB, MTP_ViewBase::getViewModel(), MTP_AnaVlv::positionFeedbackChanged);
    classConnect(this, setPosValueInternalCB, MTP_ViewBase::getViewModel(), MTP_AnaVlv::positionInternalChanged);
    classConnect(this, setOsLevelCB, MTP_ViewBase::getViewModel().getOsLevel(), MTP_OsLevel::osStationLevelChanged);
    classConnect(this, setPosManualCB, MTP_ViewBase::getViewModel(), MTP_AnaVlv::positionManualChanged);
