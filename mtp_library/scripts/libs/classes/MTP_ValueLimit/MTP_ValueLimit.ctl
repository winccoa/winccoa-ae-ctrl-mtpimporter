...
/**
 * @class MTP_ValueLimit
 * @brief Represents the MTP_ValueLimit class.
 */
class MTP_ValueLimit
{
  ...
  /**
   * @brief Constructor for MTP_ValueLimit.
   *
   ...
   */
  protected MTP_ValueLimit(const string &dpeLimit, const string &dpeEnabled, const string &dpeActive)
  {
    _dpeLimit = dpeLimit;
