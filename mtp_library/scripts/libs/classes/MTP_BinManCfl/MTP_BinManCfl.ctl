...
/**
 * @class MTP_BinManCfl
 * @brief Represents the MTP_BinManCfl class.
 */
class MTP_BinManCfl : MTP_BinMan
{
  private bool _enabled; //!< Indicates if the object is enabled.

  /**
   * @brief Constructor for the MTP_BinManCfl object.
   *
   * @param dp The data point of the MTP_BinManCfl.
   */
  public MTP_BinManCfl(const string &dp) : MTP_BinMan(dp)
  {
