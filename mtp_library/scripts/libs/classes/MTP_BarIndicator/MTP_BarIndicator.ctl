...
/**
 * @class MTP_BarIndicator
 * @brief Represents the MTP_BarIndicator class.
 */
class MTP_BarIndicator : MTP_RefBase
{
   ...
   */
  public MTP_BarIndicator(const mapping &shapes) : MTP_RefBase(shapes)
  {
  }


  /**
  * @brief Makes the values integers.
  */
  public void makeIntegerBarIndicator()
  {
    const string integerTextFormat = "[0.0f,False,False,AlignHCenter|AlignVCenter,False,False]";

    _txtValue.format = integerTextFormat;
    _txtHalfMax.format = integerTextFormat;
    _txtMax.format = integerTextFormat;
  }
  ...
  */
  ...
  /**
     ...
     *
     * @param unit A shared pointer to the MTP_Unit object.
     */
  public void setUnit(shared_ptr<MTP_Unit> unit)
  {
  ...
  {
    _body1 = MTP_RefBase::extractShape("_body1");
    _circleAH1 = MTP_RefBase::extractShape("_circleAH1");
    _circleAL1 = MTP_RefBase::extractShape("_circleAL1");
    _circlePV1 = MTP_RefBase::extractShape("_circlePV1");
    _circleTH1 = MTP_RefBase::extractShape("_circleTH1");
    _circleTL1 = MTP_RefBase::extractShape("_circleTL1");
    _circleWH1 = MTP_RefBase::extractShape("_circleWH1");
    _circleWL1 = MTP_RefBase::extractShape("_circleWL1");

    _body = MTP_RefBase::extractShape("_body");
    _circlePV = MTP_RefBase::extractShape("_circlePV");
    _circleValue = MTP_RefBase::extractShape("_circleValue");
    _pvPointer = MTP_RefBase::extractShape("_pvPointer");

    _txtHalfMax = MTP_RefBase::extractShape("_txtHalfMax");
    _txtMax = MTP_RefBase::extractShape("_txtMax");

    _txtValue = MTP_RefBase::extractShape("_txtValue");
