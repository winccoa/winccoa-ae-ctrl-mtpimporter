...
/**
 * @class MTP_AnaDrvFaceplateHome2
 * @brief Represents the MTP_AnaDrvFaceplateHome2 class.
 */
class MTP_AnaDrvFaceplateHome2 : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_AnaDrvFaceplateHome2.
   *
   * @param viewModel A shared pointer to the MTP_AnaDrv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_AnaDrvFaceplateHome2(shared_ptr<MTP_AnaDrv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_refBarIndicator, MTP_BarIndicator::setValueCustomLimit, MTP_ViewBase::getViewModel(), MTP_AnaDrv::rpmChanged);
    classConnect(this, setRpmFeedbackValueCB, MTP_ViewBase::getViewModel(), MTP_AnaDrv::rpmFeedbackSignalChanged);
    classConnect(this, setRpmValueInternalCB, MTP_ViewBase::getViewModel(), MTP_AnaDrv::rpmInternalChanged);
    classConnect(this, setOsLevelCB, MTP_ViewBase::getViewModel().getOsLevel(), MTP_OsLevel::osStationLevelChanged);
    classConnect(this, setRpmManualCB, MTP_ViewBase::getViewModel(), MTP_AnaDrv::rpmManualChanged);
