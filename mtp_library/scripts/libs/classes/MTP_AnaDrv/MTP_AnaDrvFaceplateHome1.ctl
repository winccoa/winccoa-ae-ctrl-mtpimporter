...
/**
 * @class MTP_AnaDrvFaceplateHome
 * @brief Represents the MTP_AnaDrvFaceplateHome class.
 */
class MTP_AnaDrvFaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_AnaDrvFaceplateHome.
   *
   * @param viewModel A shared pointer to the MTP_AnaDrv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_AnaDrvFaceplateHome(shared_ptr<MTP_AnaDrv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_refBarIndicator, MTP_BarIndicator::setValueCustomLimit, MTP_ViewBase::getViewModel(), MTP_AnaDrv::rpmFeedbackSignalChanged);
    classConnect(this, setSafetyPositionActiveCB, MTP_ViewBase::getViewModel(), MTP_AnaDrv::safetyPositionActiveChanged);
    classConnect(this, setMotorProtectionCB, MTP_ViewBase::getViewModel(), MTP_AnaDrv::driveSafetyIndicatorChanged);
    ...
    //Motor Icon:
    classConnectUserData(this, setMotorCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardControlChanged);
    classConnectUserData(this, setMotorCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseControlChanged);
    ...
    classConnectUserData(this, setAutomaticPreviewLineCB, "_forwardAutomatic", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardAutomaticChanged);
    classConnectUserData(this, setAutomaticPreviewLineCB, "_stopAutomatic", MTP_ViewBase::getViewModel(), MTP_AnaDrv::stopAutomaticChanged);
    classConnectUserData(this, setAutomaticPreviewLineCB, "_reverseAutomatic", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseAutomaticChanged);
    ...
    classConnectUserData(this, setResetCB, "_driveSafetyIndicator",  MTP_ViewBase::getViewModel(), MTP_AnaDrv::driveSafetyIndicatorChanged);
    ...
    classConnectUserData(this, setReverseCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setReverseCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setReverseCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseControlChanged);
    ...
    classConnectUserData(this, setStopCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setStopCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setStopCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseControlChanged);
    classConnectUserData(this, setStopCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardControlChanged);
    ...
    classConnectUserData(this, setForwardCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setForwardCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_AnaDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setForwardCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_AnaDrv::forwardControlChanged);
  ...
  {
    MTP_ViewBase::openChildPanel("objects_parts/faceplates/MTP_AnaDrv/main1_SafetyPositionInformation.pnl", "SafetyPosition Information");
  }
  ...
  private void setResetCB(const string &varName, const bool &reset)
  {
    ...
    if (_stateOperatorActive && _osLevelStation && ((_protectionEnabled && !_protection) || !_driveSafetyIndicator))
    {
