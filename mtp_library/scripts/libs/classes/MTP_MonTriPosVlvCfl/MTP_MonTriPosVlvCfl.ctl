...
/**
 * @class MTP_MonTriPosVlvCfl
 * @brief Represents the MTP_MonTriPosVlvCfl class.
 */
class MTP_MonTriPosVlvCfl : MTP_MonTriPosVlv
{
  private bool _enabled; //!< Indicates if the object is enabled.

  /**
   * @brief Constructor for the MTP_MonTriPosVlvCfl object.
   *
   * @param dp The data point of the MTP_MonTriPosVlvCfl.
   */
  public MTP_MonTriPosVlvCfl(const string &dp) : MTP_MonTriPosVlv(dp)
  {
