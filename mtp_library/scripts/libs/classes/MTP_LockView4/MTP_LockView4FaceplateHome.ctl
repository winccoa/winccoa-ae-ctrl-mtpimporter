...
/**
 * @class MTP_LockView4FaceplateHome
 * @brief Represents the MTP_LockView4FaceplateHome class.
 */
class MTP_LockView4FaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_LockView4FaceplateHome.
   *
   * @param viewModel A shared pointer to the LockView4 view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_LockView4FaceplateHome(shared_ptr<MTP_LockView4> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    ...
    classConnect(this, setOutputCB, MTP_ViewBase::getViewModel(), MTP_LockView4::outputChanged);
    classConnect(this, setLogicCB, MTP_ViewBase::getViewModel(), MTP_LockView4::logicChanged);
  ...
  {
    _txtLogic.text = logic ?  getCatStr("MTP_LockView4", "AND") :  getCatStr("MTP_LockView4", "OR");
  }
