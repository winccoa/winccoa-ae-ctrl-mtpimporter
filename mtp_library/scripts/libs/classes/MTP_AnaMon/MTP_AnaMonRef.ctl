...
/**
 * @class MTP_AnaMonRef
 * @brief Represents the MTP_AnaMonRef class.
 */
class MTP_AnaMonRef : MTP_ViewRef
{
  ...
  /**
   * @brief Constructor for the MTP_AnaMonRef object.
   *
   * @param viewModel The view model instance.
   * @param shapes The mapping of shapes used by the MTP_AnaMonRef object.
   */
  public MTP_AnaMonRef(shared_ptr<MTP_AnaMon> viewModel, const mapping &shapes) : MTP_ViewRef(viewModel, shapes)
  {
    classConnectUserData(this, setStatusCB, "_alertHighActive", MTP_ViewRef::getViewModel().getAlertHighLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnectUserData(this, setStatusCB, "_warningHighActive", MTP_ViewRef::getViewModel().getWarningHighLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnectUserData(this, setStatusCB, "_toleranceHighActive", MTP_ViewRef::getViewModel().getToleranceHighLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnectUserData(this, setStatusCB, "_toleranceLowActive", MTP_ViewRef::getViewModel().getToleranceLowLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnectUserData(this, setStatusCB, "_warningLowActive", MTP_ViewRef::getViewModel().getWarningLowLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnectUserData(this, setStatusCB, "_alertLowActive", MTP_ViewRef::getViewModel().getAlertLowLimit(), MTP_ValueLimitFloat::activeChanged);
    classConnect(this, setValueCB, MTP_ViewRef::getViewModel(), MTP_AnaMon::valueChanged);
