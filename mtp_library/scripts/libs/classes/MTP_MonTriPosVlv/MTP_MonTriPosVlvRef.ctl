...
/**
 * @class MTP_MonTriPosVlvRef
 * @brief Represents the MTP_MonTriPosVlvRef class.
 */
class MTP_MonTriPosVlvRef : MTP_ViewRef
{
  protected shape _rectError;
  ...
  protected bool _pos1StaticError;
  ...
  /**
   * @brief Constructor for the MTP_MonTriPosVlvRef object.
   *
   * @param viewModel The view model instance.
   * @param shapes The mapping of shapes used by the MTP_MonTriPosVlvRef object.
   */
  public MTP_MonTriPosVlvRef(shared_ptr<MTP_MonTriPosVlv> viewModel, const mapping &shapes) : MTP_ViewRef(viewModel, shapes)
  {
    classConnectUserData(this, setErrorCB, "_pos1StaticError", MTP_ViewRef::getViewModel().getPos1Monitor(), MTP_Monitor::staticErrorChanged);
    classConnectUserData(this, setErrorCB, "_pos2StaticError", MTP_ViewRef::getViewModel().getPos2Monitor(), MTP_Monitor::staticErrorChanged);
    classConnectUserData(this, setErrorCB, "_pos3StaticError", MTP_ViewRef::getViewModel().getPos3Monitor(), MTP_Monitor::staticErrorChanged);
    classConnectUserData(this, setErrorCB, "_pos1DynamicError", MTP_ViewRef::getViewModel().getPos1Monitor(), MTP_Monitor::dynamicErrorChanged);
    classConnectUserData(this, setErrorCB, "_pos2DynamicError", MTP_ViewRef::getViewModel().getPos2Monitor(), MTP_Monitor::dynamicErrorChanged);
    classConnectUserData(this, setErrorCB, "_pos3DynamicError", MTP_ViewRef::getViewModel().getPos3Monitor(), MTP_Monitor::dynamicErrorChanged);
    ...
    classConnectUserData(this, setConfigurationCB, "_pos1Configuration", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos1ConfigurationChanged);
    classConnectUserData(this, setConfigurationCB, "_pos2Configuration", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos2ConfigurationChanged);
    classConnectUserData(this, setConfigurationCB, "_pos3Configuration", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos3ConfigurationChanged);

    classConnectUserData(this, setValveCB, "_pos1FeedbackSignal", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos1FeedbackSignalChanged);
    classConnectUserData(this, setValveCB, "_pos2FeedbackSignal", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos2FeedbackSignalChanged);
    classConnectUserData(this, setValveCB, "_pos3FeedbackSignal", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos3FeedbackSignalChanged);
    classConnectUserData(this, setValveCB, "_pos1Control", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos1ControlChanged);
    classConnectUserData(this, setValveCB, "_pos2Control", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos2ControlChanged);
    classConnectUserData(this, setValveCB, "_pos3Control", MTP_ViewRef::getViewModel(), MTP_MonTriPosVlv::pos3ControlChanged);

    _pos1StaticError = MTP_ViewRef::getViewModel().getPos1Monitor().getStaticError();
    _pos2StaticError = MTP_ViewRef::getViewModel().getPos2Monitor().getStaticError();
    _pos3StaticError = MTP_ViewRef::getViewModel().getPos3Monitor().getStaticError();
    _pos1DynamicError = MTP_ViewRef::getViewModel().getPos1Monitor().getDynamicError();
    _pos2DynamicError = MTP_ViewRef::getViewModel().getPos2Monitor().getDynamicError();
    _pos3DynamicError = MTP_ViewRef::getViewModel().getPos3Monitor().getDynamicError();
  ...
  protected void setErrorCB(const string &varName, const bool &error)
  {
    switch (varName)
    {
      case "_pos1StaticError":
        _pos1StaticError = error;
        break;

      case "_pos2StaticError":
        _pos2StaticError = error;
        break;

      case "_pos3StaticError":
        _pos3StaticError = error;
        break;

      case "_pos1DynamicError":
        _pos1DynamicError = error;
        break;

      case "_pos2DynamicError":
        _pos2DynamicError = error;
        break;

      case "_pos3DynamicError":
        _pos3DynamicError = error;
        break;
    }

    if (_rectError.enabled())
    {
      if (hasMonitoringError())
      {
  ...
  /**
   * @brief Executes the has monitoring error operation.
   *
   * @return The result of the has monitoring error operation.
   */
  private bool hasMonitoringError()
  {
    return _pos1StaticError || _pos2StaticError || _pos3StaticError || _pos1DynamicError || _pos2DynamicError || _pos3DynamicError;
  }
  ...
  private void updateValveSymbol()
  {
    ...
    if (hasMonitoringError() || feedbackCount > 1 || controlCount > 1)
    {
