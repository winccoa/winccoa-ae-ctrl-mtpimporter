...
/**
 * @class MTP_BinDrv
 * @brief Represents the MTP_BinDrv class.
 */
class MTP_BinDrv : MTP_ActiveElement
{
  ...
  /**
      * @brief Constructor for MTP_BinDrv.
      *
      * @param dp The data point identifier for the binary drive.
      */
  public MTP_BinDrv(const string &dp) : MTP_ActiveElement(dp)
  {
