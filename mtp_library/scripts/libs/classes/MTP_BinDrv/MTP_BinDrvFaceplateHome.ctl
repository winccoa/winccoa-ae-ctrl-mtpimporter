...
/**
 * @class MTP_BinDrvFaceplateHome
 * @brief Represents the MTP_BinDrvFaceplateHome class.
 */
class MTP_BinDrvFaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_BinDrvFaceplateHome.
   *
   * @param viewModel A shared pointer to the MTP_BinDrv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_BinDrvFaceplateHome(shared_ptr<MTP_BinDrv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnectUserData(this, setMotorCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardControlChanged);
    classConnectUserData(this, setMotorCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseControlChanged);
    ...
    classConnectUserData(this, setAutomaticPreviewLineCB, "_forwardAutomatic", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardAutomaticChanged);
    classConnectUserData(this, setAutomaticPreviewLineCB, "_stopAutomatic", MTP_ViewBase::getViewModel(), MTP_BinDrv::stopAutomaticChanged);
    classConnectUserData(this, setAutomaticPreviewLineCB, "_reverseAutomatic", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseAutomaticChanged);
    ...
    classConnect(this, setMotorProtectionCB, MTP_ViewBase::getViewModel(), MTP_BinDrv::driveSafetyIndicatorChanged);
    classConnect(this, setSafetyPositionActiveCB, MTP_ViewBase::getViewModel(), MTP_BinDrv::safetyPositionActiveChanged);
    ...
    classConnectUserData(this, setResetCB, "_driveSafetyIndicator",  MTP_ViewBase::getViewModel(), MTP_BinDrv::driveSafetyIndicatorChanged);
    ...
    classConnectUserData(this, setReverseCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setReverseCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setReverseCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseControlChanged);
    ...
    classConnectUserData(this, setStopCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setStopCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setStopCB, "_reverseControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseControlChanged);
    classConnectUserData(this, setStopCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardControlChanged);
    ...
    classConnectUserData(this, setForwardCB, "_forwardFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setForwardCB, "_reverseFeedbackSignal", MTP_ViewBase::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setForwardCB, "_forwardControl", MTP_ViewBase::getViewModel(), MTP_BinDrv::forwardControlChanged);
  ...
  {
    string panelPath = "objects_parts/faceplates/MTP_BinDrv/main_BinDrvFaceplateSafetyPositionInformation.pnl";
    MTP_ViewBase::openChildPanel(panelPath, "SafetyPosition Information");
  }
