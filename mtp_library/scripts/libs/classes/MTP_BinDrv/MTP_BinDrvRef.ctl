...
/**
 * @class MTP_BinDrvRef
 * @brief Represents the MTP_BinDrvRef class.
 */
class MTP_BinDrvRef : MTP_ViewRef
{
  ...
  protected bool _driveSafetyIndicator;
  ...
  /**
   * @brief Constructor for MTP_BinDrvRef.
   *
   * @param viewModel A shared pointer to the MTP_BinDrv view model.
   * @param shapes A mapping of shapes used in the reference.
   */
  public MTP_BinDrvRef(shared_ptr<MTP_BinDrv> viewModel, const mapping &shapes) : MTP_ViewRef(viewModel, shapes)
  {
    classConnectUserData(this, setErrorCB, "_driveSafetyIndicator", MTP_ViewRef::getViewModel(), MTP_BinDrv::driveSafetyIndicatorChanged);
    ...
    classConnectUserData(this, setDirectionCB, "_forwardFeedbackSignal", MTP_ViewRef::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setDirectionCB, "_reverseFeedbackSignal", MTP_ViewRef::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);

    classConnectUserData(this, setMotorCB, "_forwardFeedbackSignal", MTP_ViewRef::getViewModel(), MTP_BinDrv::forwardFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_reverseFeedbackSignal", MTP_ViewRef::getViewModel(), MTP_BinDrv::reverseFeedbackSignalChanged);
    classConnectUserData(this, setMotorCB, "_forwardControl", MTP_ViewRef::getViewModel(), MTP_BinDrv::forwardControlChanged);
    classConnectUserData(this, setMotorCB, "_reverseControl", MTP_ViewRef::getViewModel(), MTP_BinDrv::reverseControlChanged);
