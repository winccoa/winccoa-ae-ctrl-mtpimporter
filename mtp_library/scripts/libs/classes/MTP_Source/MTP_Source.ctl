...
/**
 * @class MTP_Source
 * @brief Represents the MTP_Source class.
 */
class MTP_Source
{
  ...
  /**
   * @brief Constructor for MTP_Source.
   *
   ...
   */
  public MTP_Source(const string &dpeChannel, const string &dpeManualAutomatic, const string &dpeInternalAutomatic, const string &dpeManualOperator, const string &dpeInternalOperator, const string &dpeManualActive, const string &dpeInternalActive)
  {
...
#event internalActiveChanged(const bool &internalActive) //!< Event triggered when the internal active state changes.
  ...
  /**
  * @brief Sets the manual active state.
  *
  * @param manualActive True to set manual active state, false otherwise.
  */
  ...
  /**
  * @brief Sets the internal active state.
  *
  * @param internalActive True to set internal active state, false otherwise.
  */
