...
/**
 * @class MTP_AnaDrvCfl
 * @brief Represents the MTP_AnaDrvCfl class.
 */
class MTP_AnaDrvCfl : MTP_AnaDrv
{
  private bool _enabled; //!< Indicates if the object is enabled.

  /**
   * @brief Constructor for the MTP_AnaDrvCfl object.
   *
   * @param dp The data point of the MTP_AnaDrv.
   */
  public MTP_AnaDrvCfl(const string &dp) : MTP_AnaDrv(dp)
  {
