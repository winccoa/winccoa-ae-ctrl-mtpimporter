...
/**
 * @class MTP_LockView8Cfl
 * @brief Represents the MTP_LockView8Cfl class.
 */
class MTP_LockView8Cfl : MTP_LockView8
{
   private bool _enabled; //!< Indicates if the object is enabled.

  /**
   * @brief Constructor for the MTP_LockView8Cfl object.
   *
   * @param dp The data point of the MTP_LockView8Cfl.
   */
  public MTP_LockView8Cfl(const string &dp) : MTP_LockView8(dp)
  {
