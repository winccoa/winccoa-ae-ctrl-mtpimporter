...
/**
 * @class MTP_BinProcessValueIn
 * @brief Represents the MTP_BinProcessValueIn class.
 */
class MTP_BinProcessValueIn : MTP_InputElement
{
  ...
  /**
   * @brief Constructor for the MTP_BinProcessValueIn object.
   *
   * @param dp The data point of the MTP_BinProcessValueIn.
   */
  public MTP_BinProcessValueIn(const string &dp) : MTP_InputElement(dp)
  {
    if (!dpExists(getDp() + ".V"))
    {
   ...
   */
  public void setValue(const bool &value)
  {
    dpSet(getDp() + ".V", value);
  }
