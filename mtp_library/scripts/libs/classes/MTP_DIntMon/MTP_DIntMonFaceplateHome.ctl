...
/**
 * @class MTP_DIntMonFaceplateHome
 * @brief Represents the MTP_DIntMonFaceplateHome class.
 */
class MTP_DIntMonFaceplateHome : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_DIntMonFaceplateHome.
   *
   * @param viewModel A shared pointer to the MTP_DIntMon view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_DIntMonFaceplateHome(shared_ptr<MTP_DIntMon> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
    classConnect(_barIndicator, MTP_BarIndicator::setValueLimit, MTP_ViewBase::getViewModel(), MTP_DIntMon::valueChanged);
    classConnectUserData(this, setStatusHighCB, "_alertHighActive", MTP_ViewBase::getViewModel().getAlertHighLimit(), MTP_ValueLimitDInt::activeChanged);
    classConnectUserData(this, setStatusHighCB, "_warningHighActive", MTP_ViewBase::getViewModel().getWarningHighLimit(), MTP_ValueLimitDInt::activeChanged);
    classConnectUserData(this, setStatusHighCB, "_toleranceHighActive", MTP_ViewBase::getViewModel().getToleranceHighLimit(), MTP_ValueLimitDInt::activeChanged);
    classConnectUserData(this, setStatusLowCB, "_toleranceLowActive", MTP_ViewBase::getViewModel().getToleranceLowLimit(), MTP_ValueLimitDInt::activeChanged);
    classConnectUserData(this, setStatusLowCB, "_warningLowActive", MTP_ViewBase::getViewModel().getWarningLowLimit(), MTP_ValueLimitDInt::activeChanged);
    classConnectUserData(this, setStatusLowCB, "_alertLowActive", MTP_ViewBase::getViewModel().getAlertLowLimit(), MTP_ValueLimitDInt::activeChanged);
