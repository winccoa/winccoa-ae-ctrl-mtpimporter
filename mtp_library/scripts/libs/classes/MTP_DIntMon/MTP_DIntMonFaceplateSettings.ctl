...
/**
 * @class MTP_DIntMonFaceplateSettings
 * @brief Represents the MTP_DIntMonFaceplateSettings class.
 */
class MTP_DIntMonFaceplateSettings : MTP_ViewFaceplateSettings
{
  ...
  /**
   * @brief Constructor for MTP_DIntMonFaceplateSettings.
   *
   * @param viewModel A shared pointer to the MTP_DIntMon view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_DIntMonFaceplateSettings(shared_ptr<MTP_DIntMon> viewModel, const mapping &shapes) : MTP_ViewFaceplateSettings(viewModel, shapes)
  {
   ...
   */
  public void setAlertLimit(const int &alertLimit) = 0;
   ...
   */
  public void setWarningLimit(const int &warningLimit) = 0;
   ...
   */
  public void setToleranceLimit(const int &toleranceLimit) = 0;
