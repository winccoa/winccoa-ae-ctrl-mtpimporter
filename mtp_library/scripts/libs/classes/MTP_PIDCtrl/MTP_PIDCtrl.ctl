...
/**
 * @class MTP_PIDCtrl
 * @brief Represents the MTP_PIDCtrl class.
 */
class MTP_PIDCtrl : MTP_ActiveElement
{
  ...
  private shared_ptr<MTP_Unit> _pvUnit; //!< The unit associated with the PV value.
  private shared_ptr<MTP_Unit> _spUnit; //!< The unit associated with the SP value.
  private shared_ptr<MTP_Unit> _mvUnit; //!< The unit associated with the MV value.

  /**
   * @brief Constructor for the MTP_PIDCtrl object.
   *
   * @param dp The data point of the PID controller.
   */
  public MTP_PIDCtrl(const string &dp) : MTP_ActiveElement(dp)
  {
    ...
    _pvUnit = new MTP_Unit(getDp() + ".PVUnit");
    _spUnit = new MTP_Unit(getDp() + ".SPUnit");
    _mvUnit = new MTP_Unit(getDp() + ".MVUnit");
  }
...
#event  manipulatedValueScaleMaxChanged(const float &manipulatedValueScaleMax) //!< Event triggered when the manipulated value scale maximum changes.
   ...
   *
   * @return The state as a shared pointer to MTP_State.
   */
   ...
   *
   * @return The source as a shared pointer to MTP_Source.
   */
  ...
  /**
   * @brief Retrieves a shared pointer to the associated MTP_Unit for the process value.
   *
   * @return The shared pointer to the MTP_Unit instance.
   */
  public shared_ptr<MTP_Unit> getProcessValueUnit()
  {
    return _pvUnit;
  }

  /**
   * @brief Retrieves a shared pointer to the associated MTP_Unit for the setpoint.
   *
   * @return The shared pointer to the MTP_Unit instance.
   */
  public shared_ptr<MTP_Unit> getSetpointUnit()
  {
    return _spUnit;
  }

  /**
   * @brief Retrieves a shared pointer to the associated MTP_Unit for the manipulated value.
   *
   * @return The shared pointer to the MTP_Unit instance.
   */
  public shared_ptr<MTP_Unit> getManipulatedValueUnit()
  {
    return _mvUnit;
  }
