...
/**
 * @class MTP_BinManIntCfl
 * @brief Represents the MTP_BinManIntCfl class.
 */
class MTP_BinManIntCfl : MTP_BinManInt
{
    private bool _enabled; //!< Indicates if the object is enabled.

   /**
    * @brief Constructor for the MTP_BinManIntCfl object.
    *
    * @param dp The data point of the MTP_BinManIntCfl.
    */
   public MTP_BinManIntCfl(const string &dp) : MTP_BinManInt(dp)
  {
