...
/**
 * @class MTP_MonBinVlvFaceplateSettings
 * @brief Represents the MTP_MonBinVlvFaceplateSettings class.
 */
class MTP_MonBinVlvFaceplateSettings : MTP_ViewFaceplateSettings
{
  ...
  /**
   * @brief Constructor for MTP_MonBinVlvFaceplateSettings.
   *
   * @param viewModel A shared pointer to the MTP_MonBinVlv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_MonBinVlvFaceplateSettings(shared_ptr<MTP_MonBinVlv> viewModel, const mapping &shapes) : MTP_ViewFaceplateSettings(viewModel, shapes)
  {
