...
/**
 * @class MTP_MonBinVlvFaceplateErrorInformation
 * @brief Represents the MTP_MonBinVlvFaceplateErrorInformation class.
 */
class MTP_MonBinVlvFaceplateErrorInformation : MTP_ViewBase
{
  ...
  /**
   * @brief Constructor for MTP_MonBinVlvFaceplateErrorInformation.
   *
   * @param viewModel A shared pointer to the MTP_MonBinVlv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_MonBinVlvFaceplateErrorInformation(shared_ptr<MTP_MonBinVlv> viewModel, const mapping &shapes) : MTP_ViewBase(viewModel, shapes)
  {
  ...
  private void setSafePositionCB(const bool &safePosition)
  {
    if (safePosition)
    {
      _txtSafePosition.text = getCatStr("MTP_MonBinVlv", "safePositionOn");
    }
    else
    {
      _txtSafePosition.text = getCatStr("MTP_MonBinVlv", "safePositionOff");
    }
  }
