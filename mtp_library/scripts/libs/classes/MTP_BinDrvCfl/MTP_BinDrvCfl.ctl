...
/**
 * @class MTP_BinDrvCfl
 * @brief Represents the MTP_BinDrvCfl class.
 */
class MTP_BinDrvCfl : MTP_BinDrv
{
  private bool _enabled; //!< Indicates if the object is enabled.

  /**
   * @brief Constructor for the MTP_BinDrvCfl object.
   *
   * @param dp The data point of the MTP_BinDrvCfl.
   */
  public MTP_BinDrvCfl(const string &dp) : MTP_BinDrv(dp)
  {
