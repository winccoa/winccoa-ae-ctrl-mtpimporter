...
/**
 * @class MTP_MonBinDrvFaceplateSettings
 * @brief Represents the MTP_MonBinDrvFaceplateSettings class.
 */
class MTP_MonBinDrvFaceplateSettings : MTP_ViewFaceplateSettings
{
  ...
  /**
   * @brief Constructor for MTP_MonBinDrvFaceplateSettings.
   *
   * @param viewModel A shared pointer to the MTP_MonBinDrv view model.
   * @param shapes A mapping of shapes used in the faceplate.
   */
  public MTP_MonBinDrvFaceplateSettings(shared_ptr<MTP_MonBinDrv> viewModel, const mapping &shapes) : MTP_ViewFaceplateSettings(viewModel, shapes)
  {
