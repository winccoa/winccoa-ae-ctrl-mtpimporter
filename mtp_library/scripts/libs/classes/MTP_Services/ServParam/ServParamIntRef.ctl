 ...
 * @brief Represents the ServParamIntRef class.
 */
class ServParamIntRef : MTP_RefBase
{
   ...
   */
  public ServParamIntRef(shared_ptr<ServParamBase> param, const mapping &shapes) : MTP_RefBase(shapes)
  {
