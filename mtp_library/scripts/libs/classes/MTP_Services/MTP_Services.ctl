...
/**
 * @class MTP_Services
 * @brief Represents the MTP_Services class.
 */
class MTP_Services : MTP_DataAssembly
{
  ...
  private uint _commandOperator; //!< The operator command value.
  private uint _commandInternal; //!< The internal command value.
  private uint _commandExternal; //!< The external command value.
  private uint _stateCurrent; //!< The current state value.
  private uint _commandEnabled; //!< The command enabled value.
  private uint _positionTextId; //!< The position text ID.
  private uint _interactionQuestionId; //!< The interaction question ID.
  private string _interactionAdditionalInfo; //!< Additional information for interactions.
  private uint _interactionAnswerId; //!< The interaction answer ID.
  ...
  private shared_ptr<MTP_Procedure> _procedure; //!< The procedure associated with the monitored value.
  ...
  private dyn_string _processValueIns; //!< ProcessValueIn datapoints assigned to this service.
  private dyn_string _processValueOuts; //!< ProcessValueOut datapoints assigned to this service.

  /**
    * @brief Constructor for the MTP_Services object.
    *
    * @param dp The data point of the MTP_Services.
    */
  public MTP_Services(const string &dp) : MTP_DataAssembly(dp)
  {
    ...
    _procedure = new MTP_Procedure(getDp() + ".ProcedureOp", getDp() + ".ProcedureInt", getDp() + ".ProcedureExt", getDp() + ".ProcedureCur", getDp() + ".ProcedureReq");
  ...
  #event commandInternalChanged(const uint &commandInternal) //!< Event triggered when the internal command value changes.
  #event commandExternalChanged(const uint &commandExternal) //!< Event triggered when the external command value changes.
  #event currentStateChanged(const uint &stateCurrent) //!< Event triggered when the current state value changes.
   ...
   * @return The operator command value as a uint.
   */
  public uint getCommandOperator()
  {
   ...
   * @return The internal command value as a uint.
   */
  public uint getCommandInternal()
  {
   ...
   * @return The external command value as a uint.
   */
  public uint getCommandExternal()
  {
   ...
   * @return The current state value as a uint.
   */
   ...
   * @return The command enabled value as a uint.
   */
  public uint getCommandEnabled()
  {
   ...
   * @return The position text ID as a uint.
   */
  public uint getPositionTextId()
  {
   ...
   * @return The interaction question ID as a uint.
   */
  public uint getInteractionQuestionId()
  {
   ...
   * @return The interaction answer ID as a uint.
   */
  public uint getInteractionAnswerId()
  {
  ...
  */
  ...
  /**
  * @brief Retrieves ProcessValueIns assigned to this service.
  ...
  */
  ...
  /**
  * @brief Retrieves ProcessValueOuts assigned to this service.
  ...
  */
   ...
   * @return The shared pointer to the MTP_Procedure instance.
   */
  public shared_ptr<MTP_Procedure> getProcedure()
  {
    return _procedure;
  }
   ...
   */
  public void setCommandOperator(const uint &commandOperator)
  {
   ...
   */
  private void setCommandInternalCB(const string &dpe, const uint &commandInternal)
  {
   ...
   */
  private void setCommandExternalCB(const string &dpe, const uint &commandExternal)
  {
   ...
   */
  private void setCurrentStateCB(const string &dpe, const uint &stateCurrent)
  {
