// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_State/MTP_State.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_State/MTP_State.ctl
  @copyright $copyright
  @author m.woegrath
 */
...
// Libraries used (#uses)
#uses "std"
#uses "classes/MTP_State/MTP_State" // tested object
...
//-----------------------------------------------------------------------------
/** Tests for MTP_State.ctl
*/
class TstMTP_State : OaTest
{
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
  ...
  public int testConstructor_NoneExistingDatapoint()
  {
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".noneChannel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".noneOffAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".noneOperatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".noneAutomaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".noneOffOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".noneOperatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".noneAutomaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".noneOperatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".noneAutomaticActive", _DpExists + ".offActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".noneOffActive");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setChannelCB, state, MTP_State::channelChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setOffAutomaticCB, state, MTP_State::offAutomaticChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setOperatorAutomaticCB, state, MTP_State::operatorAutomaticChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setAutomaticAutomaticCB, state, MTP_State::automaticAutomaticChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setOperatorActiveCB, state, MTP_State::operatorActiveChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setAutomaticActiveCB, state, MTP_State::automaticActiveChanged);
  ...
  {
    shared_ptr<MTP_State> state = new MTP_State(_DpExists + ".channel", _DpExists + ".offAutomatic", _DpExists + ".operatorAutomatic", _DpExists + ".automaticAutomatic", _DpExists + ".offOperator", _DpExists + ".operatorOperator", _DpExists + ".automaticOperator", _DpExists + ".operatorActive", _DpExists + ".automaticActive", _DpExists + ".offActive");
    classConnect(this, setOffActiveCB, state, MTP_State::offActiveChanged);
