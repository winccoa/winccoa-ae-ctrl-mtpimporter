...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_ValueLimit/MTP_ValueLimitInt" // tested object
...
class TstMtpValueLimitInt : OaTest
{
  ...
  {
    shared_ptr<MTP_ValueLimitInt> limitInt = new MTP_ValueLimitInt(_DpExists + ".limit", _DpExists + ".enabled", _DpExists + ".active");
