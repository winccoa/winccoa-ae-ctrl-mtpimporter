// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_MonBinVlv/MTP_MonBinVlv.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_MonBinVlv/MTP_MonBinVlv.ctl
  @copyright $copyright
  @author d.schermann
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_MonBinVlv/MTP_MonBinVlv" // tested object
#uses "classes/oaTest/OaTest" // oaTest basic class

//-----------------------------------------------------------------------------
/** Tests for MTP_MonBinVlv.ctl
*/
class TstMTP_MonBinVlv : OaTest
{
  private const string _Dpt = "MTP_MonBinVlv";
  ...
  {
    shared_ptr<MTP_MonBinVlv> monBinVlv = new MTP_MonBinVlv(_DpExists);
  ...
  public int testConstructor_MissingMonitorDpes()
  {
    for (int i = 1; i <= dynlen(_monitorFields); i++)
    {
      try
      {
        shared_ptr<MTP_MonBinVlv> monBinVlv = new MTP_MonBinVlv(_invalidDps[i]);
