// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_Services/ServParam/DIntServParam.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_Services/ServParam/DIntServParam.ctl
  @copyright $copyright
  @author d.schermann
*/
...
#uses "classes/MTP_Services/ServParam/DIntServParam" // tested object
...
class TstDIntServParam : OaTest
{
  ...
  private const string _DptInvalidMissingVOp = "DIntServParamInvalid7";
  private const string _DptInvalidMissingVOut = "DIntServParamInvalid8";
  private const string _DpExists = "DIntServParamTestDatapoint";
  private const string _DpExistsInvalidMissingApplyEn = "DIntServParamTestDatapointInvalid1";
  private const string _DpExistsInvalidMissingVExt = "DIntServParamTestDatapointInvalid2";
  private const string _DpExistsInvalidMissingVSclMin = "DIntServParamTestDatapointInvalid3";
  private const string _DpExistsInvalidMissingVMin = "DIntServParamTestDatapointInvalid4";
  private const string _DpExistsInvalidMissingVSclMax = "DIntServParamTestDatapointInvalid5";
  private const string _DpExistsInvalidMissingVMax = "DIntServParamTestDatapointInvalid6";
  private const string _DpExistsInvalidMissingVOp = "DIntServParamTestDatapointInvalid7";
  private const string _DpExistsInvalidMissingVOut = "DIntServParamTestDatapointInvalid8";
  ...
  private int _eventValueOperator;
  private int _eventValueOutput;
  ...
  private void createType(const string &dpt)
  {
    dyn_dyn_string dpes = makeDynAnytype(
                            ...
                            makeDynString("", "VFbk"), makeDynString("", "VSclMin"), makeDynString("", "VSclMax"),
                            makeDynString("", "VMin"), makeDynString("", "VMax"), makeDynString("", "Name"),
                            makeDynString("", "VOp"), makeDynString("", "VOut"), makeDynString("", "VUnit")
                          );
    dyn_dyn_int values = makeDynAnytype(
                           ...
                           makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_INT),
                           makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_LANGSTRING),
                           makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_INT), makeDynInt(0, DPEL_INT)
                         );
  ...
  private void assertDIntServParamDpesExistExcept(const string &dp, const string &missingDpe)
  {
  ...
  public int testConstructor()
  {
    ...
    assertEqual(dintServParam.getValueOutput(), 0);
    assertEqual(dintServParam.getValueOperator(), 0);
    return 0;
  }
  ...
  public int testConstructor_MissingDpes()
  {
    ...
    assertDIntServParamDpesExistExcept(_DpExistsInvalidMissingVSclMin, "VSclMin");
    try
    {
    ...
    // Test missing VMin
    assertDIntServParamDpesExistExcept(_DpExistsInvalidMissingVMin, "VMin");
    try
    {
    ...
    assertDIntServParamDpesExistExcept(_DpExistsInvalidMissingVSclMax, "VSclMax");
    try
    {
    ...
    // Test missing VMax
    assertDIntServParamDpesExistExcept(_DpExistsInvalidMissingVMax, "VMax");
    try
    {
    ...
    try
    {
      shared_ptr<DIntServParam> dintServParam = new DIntServParam(_DpExistsInvalidMissingVOp);
    ...
    try
    {
      shared_ptr<DIntServParam> dintServParam = new DIntServParam(_DpExistsInvalidMissingVOut);
  ...
  {
    shared_ptr<DIntServParam> dintServParam = new DIntServParam(_DpExists);
    classConnect(this, setValueOperatorChangedCB, dintServParam, DIntServParam::valueOperatorChanged);

    dintServParam.setValueOperator(70);

    // Give it time to execute callback
    delay(0, 200);
    int dpValue;
    dpGet(_DpExists + ".VFbk", dpValue);
    assertEqual(dintServParam.getValueOperator(), 70, "getValueOperator should return 70");
    assertEqual(dpValue, 70, "Data point VOp should be 70");
    assertEqual(_eventValueOperator, 70, "Event value for VOp should be 70");
    return 0;
  }
  ...
  private void setValueOperatorChangedCB(const int &value)
  {
