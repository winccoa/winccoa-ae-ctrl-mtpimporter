// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_Services/ServParam/StringServParam.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_Services/ServParam/StringServParam.ctl
  @copyright $copyright
  @author d.schermann
*/
...
#uses "classes/MTP_Services/ServParam/StringServParam" // tested object
