// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_DIntManIntCfl/MTP_DIntManIntCfl.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_DIntManIntCfl/MTP_DIntManIntCfl.ctl
  @copyright $copyright
  @author d.schermann
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_DIntManIntCfl/MTP_DIntManIntCfl" // tested object
#uses "classes/oaTest/OaTest" // oaTest basic class

//-----------------------------------------------------------------------------
/** Tests for MTP_DIntManIntCfl.ctl
*/
class TstMTP_DIntManIntCfl : OaTest
{
  private const string _Dpt = "MTP_DIntManIntCfl";
  private const string _DpExists = "ExistingTestDatapoint";
  private const string _DptInvalidMissingEnabled = "MTP_DIntManIntCflInvalid1";
  ...
  {
    shared_ptr<MTP_DIntManIntCfl> dIntManIntCfl = new MTP_DIntManIntCfl(_DpExists);
    assertFalse(dIntManIntCfl.getEnabled());
    dpSetWait(_DpExists + ".enabled", TRUE);
    assertTrue(dIntManIntCfl.getEnabled());
    return 0;
  }
  ...
  public int testConstructor_MissingDpes()
  {
    try
    {
      shared_ptr<MTP_DIntManIntCfl> dIntManIntCfl = new MTP_DIntManIntCfl(_DpExistsInvalidMissingEnabled);
  ...
  {
    shared_ptr<MTP_DIntManIntCfl> dIntManIntCfl = new MTP_DIntManIntCfl(_DpExists);
    classConnect(this, enabledChangedCB, dIntManIntCfl, MTP_DIntManIntCfl::enabledChanged);
    _eventEnabled = false;
    dpSetWait(_DpExists + ".enabled", TRUE);
