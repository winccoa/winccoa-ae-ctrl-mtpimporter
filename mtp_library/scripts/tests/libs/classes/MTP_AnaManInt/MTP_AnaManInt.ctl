// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_AnaManInt/MTP_AnaManInt.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_AnaManInt/MTP_AnaManInt.ctl
  @copyright $copyright
  @author d.schermann
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_AnaManInt/MTP_AnaManInt" // tested object
#uses "classes/oaTest/OaTest" // oaTest basic class

//-----------------------------------------------------------------------------
/** Tests for MTP_AnaManInt.ctl
*/
class TstMTP_AnaManInt : OaTest
{
  private const string _Dpt = "MTP_AnaManInt";
  private const string _DpExists = "ExistingTestDatapoint";
  private const string _DptInvalidMissingVInt = "MTP_AnaManIntInvalid1";
  private const string _DpExistsInvalidMissingVInt = "ExistingTestDatapointInvalid1";
  private const string _DptInvalidMissingWQC = "MTP_AnaManIntInvalid2";
  private const string _DpExistsInvalidMissingWQC = "ExistingTestDatapointInvalid2";
  private const string _DptInvalidMissingSrcChannel = "MTP_AnaManIntInvalid3";
  ...
  {
    shared_ptr<MTP_AnaManInt> anaManInt = new MTP_AnaManInt(_DpExists);
  ...
  public int testConstructor_MissingDpes()
  {
    try
    {
      shared_ptr<MTP_AnaManInt> anaManInt = new MTP_AnaManInt(_DpExistsInvalidMissingVInt);
    ...
    try
    {
      shared_ptr<MTP_AnaManInt> anaManInt = new MTP_AnaManInt(_DpExistsInvalidMissingWQC);
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_AnaManInt> anaManInt = new MTP_AnaManInt(_DpExistsInvalidMissingSrcChannel);
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
  ...
  {
    shared_ptr<MTP_AnaManInt> anaManInt = new MTP_AnaManInt(_DpExists);
    classConnect(this, valueInternalChangedCB, anaManInt, MTP_AnaManInt::valueInternalChanged);
  ...
  private void valueInternalChangedCB(const float &valueInternal)
  {
