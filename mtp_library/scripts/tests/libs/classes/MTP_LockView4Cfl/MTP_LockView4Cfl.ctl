// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_LockView4Cfl/MTP_LockView4Cfl.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_LockView4Cfl/MTP_LockView4Cfl.ctl
  @copyright $copyright
  @author d.schermann
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_LockView4Cfl/MTP_LockView4Cfl" // tested object
#uses "classes/oaTest/OaTest" // oaTest basic class

//-----------------------------------------------------------------------------
/** Tests for MTP_LockView4Cfl.ctl
*/
class TstMTP_LockView4Cfl : OaTest
{
  private const string _Dpt = "MTP_LockView4Cfl";
  private const string _DpExists = "ExistingTestDatapoint";
  private const string _DptInvalidMissingEnabled = "MTP_LockView4CflInvalid1";
  ...
  {
    shared_ptr<MTP_LockView4Cfl> lockView4Cfl = new MTP_LockView4Cfl(_DpExists);
    assertFalse(lockView4Cfl.getEnabled());
    dpSetWait(_DpExists + ".enabled", true);
    assertTrue(lockView4Cfl.getEnabled());
    return 0;
  }
  ...
  public int testConstructor_MissingDpes()
  {
    try
    {
      shared_ptr<MTP_LockView4Cfl> lockView4Cfl = new MTP_LockView4Cfl(_DpExistsInvalidMissingEnabled);
  ...
  {
    shared_ptr<MTP_LockView4Cfl> lockView4Cfl = new MTP_LockView4Cfl(_DpExists);
    classConnect(this, enabledChangedCB, lockView4Cfl, MTP_LockView4Cfl::enabledChanged);
    _eventEnabled = false;
    dpSetWait(_DpExists + ".enabled", true);
    delay(0, 200);
