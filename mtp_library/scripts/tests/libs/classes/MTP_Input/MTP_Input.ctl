// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_Input/MTP_Input.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_Input/MTP_Input.ctl
  @copyright $copyright
  @author m.woegrath
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_Input/MTP_Input"  // tested object
...
//-----------------------------------------------------------------------------
/** Tests for MTP_Input.ctl
*/
class TstMTP_Input : OaTest
{
  ...
  {
    shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".value", _DpExists + ".inverted", _DpExists + ".text", _DpExists + ".qc");
  ...
  public int testConstructor_NoneExistingDatapoint()
  {
    try
    {
      shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".noneEnabled", _DpExists + ".value", _DpExists + ".inverted", _DpExists + ".text", _DpExists + ".qc");
    ...
    try
    {
      shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".noneValue", _DpExists + ".inverted", _DpExists + ".text", _DpExists + ".qc");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".value", _DpExists + ".noneInverted", _DpExists + ".text", _DpExists + ".qc");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".value", _DpExists + ".inverted", _DpExists + ".noneText", _DpExists + ".qc");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
  ...
  {
    shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".value", _DpExists + ".inverted", _DpExists + ".text", _DpExists + ".qc");
    classConnect(this, setEnabledCB, input, MTP_Input::enabledChanged);
  ...
  {
    shared_ptr<MTP_Input> input = new MTP_Input(_DpExists + ".enabled", _DpExists + ".value", _DpExists + ".inverted", _DpExists + ".text", _DpExists + ".qc");
    classConnect(this, setValueCB, input, MTP_Input::valueChanged);
