// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_MonTriPosVlv/MTP_MonTriPosVlv.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_MonTriPosVlv/MTP_MonTriPosVlv.ctl
  @copyright $copyright
  @author d.schermann
 */
...
//-----------------------------------------------------------------------------
// Libraries used (#uses)
#uses "classes/MTP_MonTriPosVlv/MTP_MonTriPosVlv" // tested object
#uses "classes/oaTest/OaTest" // oaTest basic class

//-----------------------------------------------------------------------------
/** Tests for MTP_MonTriPosVlv.ctl
*/
class TstMTP_MonTriPosVlv : OaTest
{
  private const string _Dpt = "MTP_MonTriPosVlv";
  ...
  public int setUp() override
  {
    ...
    _monitorFields = makeDynString("MonEn", "MonSafePos",
                                   "Pos1MonStatErr", "Pos1MonDynErr", "Pos1MonStatTi", "Pos1MonDynTi",
                                   "Pos2MonStatErr", "Pos2MonDynErr", "Pos2MonStatTi", "Pos2MonDynTi",
                                   "Pos3MonStatErr", "Pos3MonDynErr", "Pos3MonStatTi", "Pos3MonDynTi");
  ...
  {
    shared_ptr<MTP_MonTriPosVlv> monTriPosVlv = new MTP_MonTriPosVlv(_DpExists);
    assertEqual(monTriPosVlv.getDp(), _DpExists);
    assertTrue(monTriPosVlv.getPos1Monitor() != nullptr);
    assertTrue(monTriPosVlv.getPos2Monitor() != nullptr);
    assertTrue(monTriPosVlv.getPos3Monitor() != nullptr);
    assertTrue(monTriPosVlv.getState() != nullptr);
    assertTrue(monTriPosVlv.getSecurity() != nullptr);
    return 0;
  }
  ...
  public int testConstructor_MissingMonitorDpes()
  {
    for (int i = 1; i <= dynlen(_monitorFields); i++)
    {
      try
      {
        shared_ptr<MTP_MonTriPosVlv> monTriPosVlv = new MTP_MonTriPosVlv(_invalidDps[i]);
