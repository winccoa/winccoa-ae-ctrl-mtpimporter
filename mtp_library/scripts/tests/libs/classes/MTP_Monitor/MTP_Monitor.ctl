// $License: NOLICENSE
/** Tests for the library: scripts/libs/classes/MTP_Monitor/MTP_Monitor.ctl.

  @file $relPath
  @test Unit tests for the library: scripts/libs/classes/MTP_Monitor/MTP_Monitor.ctl
  @copyright $copyright
  @author m.woegrath
 */
...
// Libraries used (#uses)
#uses "std"
#uses "classes/MTP_Monitor/MTP_Monitor" // tested object
...
//-----------------------------------------------------------------------------
/** Tests for MTP_Monitor.ctl
*/
class TstMTP_Monitor : OaTest
{
  ...
  {
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
  ...
  public int testConstructor_NoneExistingDatapoint()
  {
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".noneEnabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    ...
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".noneSafePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".noneStaticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".noneDynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".noneStaticTime", _DpExists + ".dynamicTime");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
    ...
    try
    {
      shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".noneDynamicTime");
      assertTrue(false, "shouldn't reach here");
    }
    catch
    {
  ...
  {
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    classConnect(this, setStaticErrorCB, monitor, MTP_Monitor::staticErrorChanged);
  ...
  {
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    classConnect(this, setDynamicErrorCB, monitor, MTP_Monitor::dynamicErrorChanged);
  ...
  {
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    classConnect(this, setSafePositionCB, monitor, MTP_Monitor::safePositionChanged);
  ...
  public int testGetStaticTime()
  {
    ...
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    classConnect(this, setStaticTimeCB, monitor, MTP_Monitor::staticTimeChanged);
  ...
  public int testGetDynamicTime()
  {
    ...
    shared_ptr<MTP_Monitor> monitor = new MTP_Monitor(_DpExists + ".enabled", _DpExists + ".safePosition", _DpExists + ".staticError", _DpExists + ".dynamicError", _DpExists + ".staticTime", _DpExists + ".dynamicTime");
    classConnect(this, setDynamicTimeCB, monitor, MTP_Monitor::dynamicTimeChanged);
